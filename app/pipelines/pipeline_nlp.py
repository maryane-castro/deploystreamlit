...
class PipelineNLP:
    ...
    def set_input(self, path_json, imagem_local):
        """
        ...
        self.leaflet_image = imagem_local
    ...
    def run(self, path_intermediate_json, path_final_json):
        ...
        json_object = save_nlp_final_json(path_final_json, bd_results, self.leaflet_id, self.page_number, self.offers, self.similarity_threshold)
